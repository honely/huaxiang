...
class PHPExcel_Calculation_Financial
{
     ...
     * This function is provided for the French accounting system. If an ziyuan is purchased in
     ...
     * @access    public
     * @category Financial Functions
     * @param    float    cost        The cost of the ziyuan.
     * @param    mixed    purchased    Date of the purchase of the ziyuan.
     * @param    mixed    firstPeriod    Date of the end of the first period.
     * @param    mixed    salvage        The salvage value at the end of the life of the ziyuan.
     ...
     * DB
     *
     * Returns the depreciation of an ziyuan for a specified period using the
     ...
     * @access    public
     * @category Financial Functions
     * @param    float    cost        Initial cost of the ziyuan.
     * @param    float    salvage        Value at the end of the depreciation.
     *                                (Sometimes called the salvage value of the ziyuan)
     * @param    integer    life        Number of periods over which the ziyuan is depreciated.
     *                                (Sometimes called the useful life of the ziyuan)
     ...
     * SLN
     *
     * Returns the straight-line depreciation of an ziyuan for one period
     *
     * @param    cost        Initial cost of the ziyuan
     * @param    salvage        Value at the end of the depreciation
     * @param    life        Number of periods over which the ziyuan is depreciated
     * @return    float
     */
     ...
     * SYD
     *
     * Returns the sum-of-years' digits depreciation of an ziyuan for a specified period.
     *
     * @param    cost        Initial cost of the ziyuan
     * @param    salvage        Value at the end of the depreciation
     * @param    life        Number of periods over which the ziyuan is depreciated
