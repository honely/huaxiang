...
namespace phpmailer;
class receiver{
    var $server = 'mail.welho.me';
    var $username = 'mengmeng.dang@welho.me';
    var $password = 'dmm1586,1.q';

    var $marubox = '';

    var $email = '';

    function receiveMail($username, $password, $EmailAddress, $mailserver = 'localhost', $servertype = 'pop', $port = '465', $ssl = false)
    { //Constructure
        if ($servertype == 'imap') {
            if ($port == '')
                $port = '143';
