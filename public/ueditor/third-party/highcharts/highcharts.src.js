...
SVGElement.prototype = {
	...
	*/
	...
	destroy: function () {
		...
		// In case of useHTML, light up empty containers emulating SVG groups (#1960).
 ...
 * - series.xData and series.processedXData contain light x values, equivalent to series.data and series.points.
 * - series.yData and series.processedYData contain light x values, equivalent to series.data and series.points.
 *
 * @param {Object} chart
 * @param {Object} options
 */
