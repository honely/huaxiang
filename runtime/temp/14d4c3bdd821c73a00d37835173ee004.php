    ...
    <div style="padding: 15px;">
        <form class="layui-form layui-form-pane1" action="<?=url('admin/edit')?>?ad_id=<?php echo $admin['ad_id']; ?>" method="post">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input type="text" name="ad_corp" placeholder="请输入公司" autocomplete="off" class="layui-input" value="<?php echo $admin['ad_corp']; ?>" >
                </div>
            </div>
            <div class="layui-form-item">
