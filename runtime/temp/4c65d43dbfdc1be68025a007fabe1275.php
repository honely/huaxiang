            ...
            <form class="layui-form" action="<?=url('house/edit')?>?id=<?php echo $house['id']; ?>" method="post">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="text" name="title" lay-verify="required|title" placeholder="请输入房源名称" autocomplete="off" value="<?php echo $house['title']; ?>" class="layui-input">
                    </div>
                </div>
                <div class="layui-form-item">
                    <label class="layui-form-label"><span style="color: red;">*</span>地址</label>
                    <div class="layui-input-block">
                        <input type="text" name="address" id="address" lay-verify="required|title" placeholder="请输入地址" value="<?php echo $house['address']; ?>" autocomplete="on" class="layui-input">
                    </div>
                </div>
                <div class="layui-form-item">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        <select name="city" lay-verify="required" lay-filter="bu_p_id">
                            ...
                            <option value="<?php echo $vo['id']; ?>" <?php if($house['city'] == $vo['id']): ?>selected<?php endif; ?>><?php echo $vo['name']; ?></option>
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        <input type="checkbox" name="open" lay-skin="switch" lay-filter="switchTest" lay-text="随时|限时" <?php if($house['live_date'] == 00-00-00): ?>checked<?php else: endif; ?> >
                    </div>
                </div>
                <div class="layui-form-item">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        ...
                        <input type="checkbox" class="checkbox" lay-skin="primary" name="furniture[<?php echo $vo['furn']; ?>]" title="<?php echo $vo['furn']; ?>"  <?php echo !empty($vo['is_checked'])?'checked' : ''; ?>>
                        <?php endforeach; endif; else: echo "" ;endif; ?>
                    </div>
                </div>
                ...
                <div class="layui-form-item" pane="">
                    ...
                    <div class="layui-input-block">
                        ...
                        <input type="checkbox" class="checkbox" lay-skin="primary" name="home[<?php echo $vo['set']; ?>]" title="<?php echo $vo['set']; ?>"  <?php echo !empty($vo['is_checked'])?'checked' : ''; ?>>
                        <?php endforeach; endif; else: echo "" ;endif; ?>
                    </div>
                </div>
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="text" name="tel" lay-verify="required|phone" placeholder="请输入电话" value="<?php echo $house['tel']; ?>" autocomplete="off" class="layui-input">
                    </div>
                </div>
                <div class="layui-form-item">
