<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:93:"D:\phpStudy\PHPTutorial\WWW\newxcx\huaxiang\public/../application/xcx\view\inspect\apply.html";i:1603697199;s:82:"D:\phpStudy\PHPTutorial\WWW\newxcx\huaxiang\application\xcx\view\index\header.html";i:1591180794;s:82:"D:\phpStudy\PHPTutorial\WWW\newxcx\huaxiang\application\xcx\view\index\footer.html";i:1577269681;}*/ ?>
<!DOCTYPE html>
            ...
            <section class="panel panel-padding">
                <table lay-skin="line" class="layui-table" lay-filter="demo" lay-data="{height: 'full-200', cellMinWidth:60, url:'/xcx/inspect/applyData/', limit:50,limits:[50] ,id: 'testReload',page:true}" >
                    ...
                    <tr>
                        ...
                        <th lay-data="{field:'u_name',width:150}">姓名</th>
                        <th lay-data="{field:'u_phone',width:150}">手机号</th>
                        <th lay-data="{field:'u_email',width:150}">邮箱</th>
                        <th lay-data="{field:'u_book_time',width:150}">预约时间</th>
                        <th lay-data="{field:'u_book_times',width:150}">预约时间段</th>
