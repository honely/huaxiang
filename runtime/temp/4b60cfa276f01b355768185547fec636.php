<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:91:"D:\phpStudy\PHPTutorial\WWW\newxcx\huaxiang\public/../application/xcx\view\login\login.html";i:1591172114;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<div class="login">
    ...
    <form class="layui-form" method="post" action="<?=url('login/login')?>">
        <div class="layui-form-item">
            <input type="username" name="username" placeholder="请输入邮箱" lay-verify="required|email" autocomplete="off" class="layui-input">
        </div>
        <div class="layui-form-item">
