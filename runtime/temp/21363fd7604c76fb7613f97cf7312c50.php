...
<div class="layui-body">
    <div style="padding: 15px;">
        <form class="layui-form layui-form-pane1" action="<?=url('account/personal')?>" method="post">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <select name="ad_role" id="roleaa" disabled lay-verify="required">
            ...
            <div class="layui-upload">
                ...
                <div class="layui-input-inline">
                    <img class="layui-upload-img" id="demo1" src="../../../<?php echo $admin['ad_img']; ?>">
                    <p id="demoText"></p>
                </div>
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input type="text" name="ad_bid" value="<?php echo $admin['ad_bid']; ?>" placeholder="请输入工号" autocomplete="off"  class="layui-input">
                </div>
            </div>
            <div class="layui-form-item">
