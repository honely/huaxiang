<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:90:"D:\phpStudy\PHPTutorial\WWW\newxcx\huaxiang\public/../application/xcx\view\corp\apply.html";i:1603692616;s:82:"D:\phpStudy\PHPTutorial\WWW\newxcx\huaxiang\application\xcx\view\index\header.html";i:1591180794;s:82:"D:\phpStudy\PHPTutorial\WWW\newxcx\huaxiang\application\xcx\view\index\footer.html";i:1577269681;}*/ ?>
<!DOCTYPE html>
    ...
    <div class="layui-tab-content" style="height: 100px;">
        <div class="layui-tab-item layui-show">
            <section class="panel panel-padding">
                <table lay-skin="line" class="layui-table" lay-filter="demo" lay-data="{height: 'full-200', cellMinWidth:60, url:'/xcx/corp/applyData/', limit:50,limits:[50] ,id: 'testReload',page:true}" >
                    <thead>
                    <tr>
                        <th lay-data="{field:'i_id',width:80}">id</th>
                        <th lay-data="{field:'corp_name',width:150}">公司名称</th>
                        <th lay-data="{field:'phone',width:150}">手机号</th>
                        <th lay-data="{field:'email',width:150}">邮箱</th>
                        <th lay-data="{field:'wechat',width:150}">联系微信</th>
                        <th lay-data="{field:'status',width:100}">状态</th>
                        <th lay-data="{field:'ctime',width:180}">提交时间</th>
                        <th lay-data="{field:'uid',width:150}">提交人</th>
                    </tr>
                    </thead>
                </table>
            </section>
