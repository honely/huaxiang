    ...
    layui.use(['table','laydate','form'], function(){
        ...
        table.render({
            ...
            ,cols: [[
                ...
                ,{field:'ba_img', title: '广告封面',templet:'<div><img src="../../..{{ d.ba_img}}"></div>'}
