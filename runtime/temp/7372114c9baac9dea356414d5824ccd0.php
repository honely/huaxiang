        ...
        <div style="padding: 15px;">
            <form class="layui-form" action="<?=url('house/edit')?>?id=<?php echo $house['id']; ?>" method="post">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        <input type="text" name="live_date" lay-verify="date" lay-verify="required" placeholder="请选择入住时间" value="<?php if($house['live_date'] == 0000-00-00): ?>随时<?php else: ?><?php echo $house['live_date']; endif; ?>" autocomplete="off" class="layui-input">
                    </div>
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        ...
                        <input type="radio" name="source" disabled value="个人" title="个人" <?php if($house['source'] == '个人'): ?>checked<?php endif; ?>>
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        ...
                        <input type="checkbox" class="checkbox" disabled lay-skin="primary" name="furniture[<?php echo $vo['furn']; ?>]" title="<?php echo $vo['furn']; ?>"  <?php echo !empty($vo['is_checked'])?'checked' : ''; ?>>
                        <?php endforeach; endif; else: echo "" ;endif; ?>
                    </div>
                </div>
                ...
                <div class="layui-form-item" pane="">
                    ...
                    <div class="layui-input-block">
                        ...
                        <input type="checkbox" class="checkbox" disabled lay-skin="primary" name="home[<?php echo $vo['set']; ?>]" title="<?php echo $vo['set']; ?>"  <?php echo !empty($vo['is_checked'])?'checked' : ''; ?>>
                        <?php endforeach; endif; else: echo "" ;endif; ?>
                    </div>
                </div>
